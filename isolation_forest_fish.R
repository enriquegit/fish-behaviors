...
dataset <- read.csv("fishFeatures.csv",
                    stringsAsFactors = T)

#### Split into train/test sets ####

# We will try without abnormal cases during training.
...
# First we define the parameters. nproc is the number of cores in the CPU.
